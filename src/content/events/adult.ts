...
export const adultEvents: GameEvent[] = [
  ...
  },
  {
    ...
    weight: 4,
    requirements: { hasKids: true },
    text: `Your kid's school play is tonight. They're playing "Tree #3." They've been rehearsing their one line for two weeks. You have a work deadline.`,
    choices: [
      { id: 'go', label: 'Go to the play, deadline be damned', effects: { happiness: 15, stress: 10, relationshipDelta: 15 }, resultText: `They said "The wind is blowing!" with more conviction than any Shakespeare you've ever seen. You cried. At a tree. In an elementary school gym.` },
      { id: 'miss', label: 'Stay late at work', effects: { money: 5, happiness: -15, stress: 5, relationshipDelta: -15 }, resultText: `Your kid didn't say anything when you got home. That was worse than if they'd yelled. The deadline was met. The guilt wasn't.` },
      { id: 'record', label: 'Ask your spouse to FaceTime you the performance', effects: { happiness: 5, stress: 10, relationshipDelta: -5 }, resultText: `The video was shaky and you couldn't hear the line. But you watched it fourteen times. You'll be there next time. You swore it.` },
    ],
  },
  {
    id: 'adult_042',
    ...
    category: 'social',
    weight: 3,
    text: `You're thinking about getting a tattoo. At 44. Your spouse called it "a phase." Your coworker called it "brave." Your mom called it "a mistake."`,
    choices: [
      { id: 'get_it', label: 'Get the tattoo', effects: { happiness: 15, looks: 3, money: -5, reputation: 5 }, resultText: `A small mountain range on your forearm. It hurt more than expected. You love it more than expected. Your mom hasn't seen it yet.` },
      { id: 'wait', label: 'Think about it for another year', effects: { happiness: -3, stress: 3 }, resultText: `You saved three tattoo designs on Pinterest. By next year you'll want something different. The cycle continues.` },
      { id: 'temporary', label: 'Get a temporary one first to test', effects: { happiness: 5, smarts: 5 }, resultText: `The stick-on tattoo lasted 4 days. You loved days 1-2 and were over it by day 3. Valuable data. Decision postponed.` },
    ],
  },
  {
    id: 'adult_043',
    ...
    category: 'housing',
    weight: 4,
    text: `The HOA sent you a letter. Your trash cans were visible from the street for 47 minutes past the allowed window. The fine: $75. You're considering arson.`,
    choices: [
      { id: 'pay', label: 'Pay it and fume silently', effects: { money: -3, happiness: -10, stress: 10 }, resultText: `You paid $75 for the crime of taking trash cans in slightly late. You now set a phone alarm for trash day. This is what adulthood is.` },
      { id: 'fight', label: 'Appeal the fine at the next HOA meeting', effects: { stress: 15, happiness: 5, reputation: 5 }, resultText: `You showed up with a printed timeline and a speech about "community values." The board of retired people stared at you. Fine reduced to $25. Victory, technically.` },
      { id: 'board', label: 'Run for the HOA board to fix it from inside', effects: { stress: 15, smarts: 5, reputation: 10 }, resultText: `You won unopposed because nobody else wanted the job. You now spend Tuesday evenings debating fence heights. You've become what you swore to destroy.` },
    ],
  },
  {
    id: 'adult_044',
    ...
    weight: 3,
    requirements: { hasKids: true },
    text: `Your youngest just left for college. The house is quiet. Too quiet. You walked past their empty room and just... stood there.`,
    choices: [
      { id: 'project', label: 'Turn their room into a home office', effects: { happiness: 5, stress: -5, smarts: 3 }, resultText: `New desk, new paint. It looks great. You kept one of their posters on the wall. Just one. For now.` },
      { id: 'grieve', label: 'Let yourself feel it', effects: { happiness: -10, stress: 5, health: 5 }, resultText: `You sat on their bed for twenty minutes. Cried a little. Called them. They were fine. Happy, even. That helped and hurt at the same time.` },
      { id: 'freedom', label: 'Celebrate the freedom', effects: { happiness: 15, stress: -10 }, resultText: `You ate cereal for dinner. Watched TV at full volume. Stayed up late on a Tuesday. This is what 18 years of parenting earned you. It was glorious and lonely.` },
    ],
  },
  {
    id: 'adult_045',
    ...
    category: 'social',
    weight: 3,
    text: `Your 20-year class reunion. The invite says "casual." Nothing about going back to high school is casual. The person you had a crush on RSVP'd yes.`,
    choices: [
      { id: 'go', label: 'Show up looking your best', effects: { happiness: 10, looks: 3, stress: 5, money: -3 }, resultText: `Half the people looked exactly the same. Half were unrecognizable. Your crush got into real estate. The mystery is gone but the night was fun.` },
      { id: 'skip', label: 'Hard pass', effects: { happiness: 5, stress: -5 }, resultText: `You stalked the photos on Facebook the next day. You made the right call. The DJ played "Cha Cha Slide" unironically.` },
      { id: 'late', label: 'Show up fashionably late to scope it out', effects: { happiness: 5, smarts: 5, stress: 3 }, resultText: `You arrived at 9, scanned the room, had two drinks, told three people "you look great," and left by 10. Efficient. Strategic. Adult.` },
    ],
  },
  {
    id: 'adult_046',
    ...
    category: 'family',
    weight: 4,
    text: `Your parent needs to move in with you. They're healthy, just can't keep up the house anymore. Your spare room is about to get a lot less spare.`,
    choices: [
      { id: 'welcome', label: 'Welcome them warmly', effects: { happiness: 5, stress: 15, relationshipDelta: 15, money: -5 }, resultText: `They moved in with three boxes and forty years of opinions about how you load the dishwasher. It's hard. It's also the most time you've spent together since childhood.` },
      { id: 'boundaries', label: 'Set very clear boundaries first', effects: { stress: 10, smarts: 5, relationshipDelta: 5 }, resultText: `"My house, my rules" sounded tougher in your head. They agreed to everything and then did whatever they wanted anyway. Love is complicated.` },
      { id: 'alternative', label: 'Research other living arrangements', effects: { stress: 10, money: -10, happiness: -5 }, resultText: `You toured three senior communities. They were nice. Your parent cried in the car. You cancelled the tours. They moved in the next week.` },
    ],
  },
  {
    id: 'adult_047',
  ...
  },
  {
    ...
    category: 'social',
    weight: 3,
    text: `You discovered podcasts. Not casually. You're now subscribed to 47 shows and have opinions about microphone quality. Your commute isn't long enough anymore.`,
    choices: [
      { id: 'deep', label: 'Go deeper into the rabbit hole', effects: { smarts: 10, happiness: 5, health: -3 }, resultText: `You now listen at 1.5x speed while doing chores. You have opinions about true crime, geopolitics, AND sourdough. Your spouse is concerned.` },
      { id: 'start', label: 'Start your own podcast', effects: { happiness: 10, money: -3, reputation: 5 }, resultText: `"Welcome to episode one of Dad Thoughts." 12 listeners. Your mom and 11 bots. But you love it. The garage is now a "studio."` },
      { id: 'curate', label: 'Become the friend who recommends podcasts', effects: { reputation: 3, happiness: 5, relationshipDelta: -3 }, resultText: `"You HAVE to listen to this episode." Nobody has to. Nobody does. But you keep sending links. This is who you are now.` },
    ],
  },
  {
    id: 'adult_049',
    ...
    category: 'health',
    weight: 4,
    text: `You tried to keep up with your teenager's workout routine. Squats, burpees, mountain climbers. You are 46 and your knees have filed a formal complaint.`,
    choices: [
      { id: 'adapt', label: 'Modify the routine for your age', effects: { health: 10, happiness: 5, smarts: 5 }, resultText: `Low impact. Proper form. Stretching. You're slower but consistent. Your teen said "good job, old man." You took it as a compliment.` },
      { id: 'compete', label: 'Refuse to slow down', effects: { health: -10, happiness: 5, stress: 10 }, resultText: `You kept up for exactly one session. Then your back went out reaching for the water bottle. Physical therapy appointment booked.` },
      { id: 'separate', label: 'Do your own thing', effects: { health: 5, happiness: 5, stress: -5 }, resultText: `You started walking. Just walking. Three miles a day. It doesn't look impressive on Instagram but your body thanked you immediately.` },
    ],
  },
  {
    id: 'adult_050',
    ...
    category: 'absurd',
    weight: 2,
    text: `You spent $400 on a fancy espresso machine. The latte art videos made it look easy. It is not easy. Your kitchen looks like a crime scene.`,
    choices: [
      { id: 'master', label: 'Practice until you nail it', effects: { happiness: 10, smarts: 5, money: -3 }, resultText: `Three weeks and 50 pounds of beans later, you made a heart. A lopsided heart. You photographed it from seven angles. Peak adult achievement.` },
      { id: 'give_up', label: 'Go back to the coffee shop', effects: { happiness: 5, money: -5, stress: -5 }, resultText: `The barista asked where you'd been. "On a journey," you said. The $400 machine is now the world's most expensive kitchen decoration.` },
      { id: 'simple', label: 'Just make regular coffee with it', effects: { happiness: 5, smarts: 3 }, resultText: `No art. No foam. Just strong espresso. It's actually great. The machine works perfectly for something it wasn't marketed for. Like most things in life.` },
    ],
  },
];
